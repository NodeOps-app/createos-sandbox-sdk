...
[Concepts](https://docs.createos.sh/Sandbox/Concepts).
...
- **Delegated access** — issue, inspect, rotate, or disable a token scoped to
  one sandbox. See the [example](examples/57-sandbox-access-token/).
